...
public class CircularAnim {
    ...
    public static class VisibleBuilder {
        ...
        private android.view.View mAnimView, mTriggerView;
        ...
        public VisibleBuilder(android.view.View animView, boolean isShow) {
            mAnimView = animView;
            this.isShow = isShow;
         ...
         */
        public VisibleBuilder triggerView(android.view.View triggerView) {
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            mAnimView.setVisibility(android.view.View.VISIBLE);
        ...
        private void doOnEnd() {
            if (isShow)
                ...
                mAnimView.setVisibility(android.view.View.INVISIBLE);
    ...
    public static class FullActivityBuilder {
        ...
        private long animDelayMillis=1000L;//开始和结束动画间的间隔

        public FullActivityBuilder(Activity activity, android.view.View triggerView) {
            mActivity = activity;
         ...
         * this will be override by {@link FullActivityBuilder#drawable(android.graphics.drawable.Drawable)}
         */
         ...
         */
        public FullActivityBuilder drawable(android.graphics.drawable.Drawable drawable) {
            mDrawable = drawable;
            return this;
        }
        ...
        public FullActivityBuilder setAnimDelayMillis(long animDelayMillis) {
            this.animDelayMillis = animDelayMillis;
            return this;
        }
    }
    ...
    /* 伸展并显示@animView */
    public static VisibleBuilder show(android.view.View animView) {
        return new VisibleBuilder(animView, true);
    }

    /* 收缩并隐藏@animView */
    public static VisibleBuilder hide(android.view.View animView) {
        return new VisibleBuilder(animView, false);
    }

    /* 以@triggerView 为触发点铺满整个@activity */
    public static FullActivityBuilder fullActivity(Activity activity, android.view.View triggerView) {
